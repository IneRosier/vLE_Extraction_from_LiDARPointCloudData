The three folders: 'SA1', 'SA2', and 'SA3' contain the reference LiDAR point clouds used in the publication 'A workflow to extract the geometry and type of vegetated 2 landscape elements from airborne LiDAR point clouds'. The name of the files consists of three components separated by an underscore. The first part indicates the study area, the second part indicates the vegetated landscape element type and the third component indicates a unique id. 
