# -*- coding: utf-8 -*-
"""
Created on Tue Mar 23 18:23:51 2021
...
conc_hull_folder = r'C:\Users\u0117123\Box Sync\FWO\WP1\Point-cloud-extractions\processing\5_Clustering_classification\Reference\hulls'
...
#input path polygons
polygon_path = conc_hull_folder + '\compiled_hull_Reference_merge_dissolve.shp'
...
#create bat files
with open(os.path.join(directory, 'batch_temp_Reference_Neerijse.bat'), 'w') as OPATH:
...
with open(os.path.join(directory, 'batch_temp_Reference_Velm.bat'), 'w') as OPATH:
      OPATH.writelines(["lasclip ",
